...
from survey.views import IndexView, SurveyView, SurveyResultsView, SurveyNewView, SurveyEditView, BallotResultsView
...
urlpatterns = patterns(
    ...
    url(r'^(?P<slug>[-_\w]+)/publish/$', 'publishSurvey', name='publishsurvey'),
