...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ballot.ip'
        db.alter_column('survey_ballot', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Ballot.ip'
        db.alter_column('survey_ballot', 'ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))
